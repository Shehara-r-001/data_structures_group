...
public class number_input extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_number_input, container, false);
...
//                                 Toast.makeText(number_input.this.getContext(), searchNum + " " + "is not in the B-Tree", Toast.LENGTH_LONG).show();
                             }
                         }
                     } else {
                         Toast.makeText(number_input.this.getContext(), "Enter number before click Add button", Toast.LENGTH_LONG).show();
                     }
                 }
             });
             refresh3.setOnClickListener(new View.OnClickListener() {
    ...
    public void numSearch(float[] arr, TextView textView) {
        for (int l = 0; l < arr.length; l++) {
            if (searchNum == arr[l]) {
                ...
                Toast.makeText(number_input.this.getContext(), searchNum + " " + "is found in B-Tree", Toast.LENGTH_LONG).show();
            }
        }
    }
...
//                Toast.makeText(number_input.this.getContext(), arrayList3.toString(), Toast.LENGTH_LONG).show();
                Toast.makeText(number_input.this.getContext(), "B-Tree of level 2 was created.", Toast.LENGTH_LONG).show();
            }
