...
public class array_input extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_array_input, container, false);
...
//                                Toast.makeText(array_input.this.getContext(), searchNum + " " + "was not in B-Tree", Toast.LENGTH_LONG).show();
                            }
                        }
                    } else {
                        Toast.makeText(array_input.this.getContext(), "Enter number before click Add button", Toast.LENGTH_LONG).show();
                    }
                }
            });
            clear2.setOnClickListener(new View.OnClickListener() {
    ...
    public void remove() {
        if (number_array != null) {
            ...
            Toast.makeText(array_input.this.getContext(), arrayList2.toString(), Toast.LENGTH_LONG).show();
            s = arrayList2.size();

            Log.d("eeeeeeertrtreeeeeeeeeee", String.valueOf(s));
        } else {
            Toast.makeText(array_input.this.getContext(), "Enter number before click Remove button", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void numSearch(float[] arr, TextView textView) {
        for (int l = 0; l < arr.length; l++) {
            if (searchNum == arr[l]) {
                ...
                Toast.makeText(array_input.this.getContext(), searchNum + " " + "is found in B-Tree", Toast.LENGTH_LONG).show();
            }
        }
    }
